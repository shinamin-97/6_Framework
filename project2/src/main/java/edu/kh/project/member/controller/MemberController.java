...
//	@RequestMapping(value ="/member/login", method = RequestMethod.POST)
	...
	// * @ModelAttrilbute 어노테이션 생략도 가능!
	// == 커맨드 객체
	
	// * 참고 *
	// Controller 메소드 매개변수에 객체를 작성하면
	...
	public String signUp(Member inputMember /* 커맨드 객체 */, String[] memberAddress /* name 속성값이 memberAddress인 값을 배열로 반환 */,
			RedirectAttributes ra, @RequestHeader("referer") String referer) {
		
		// 한글이 깨지는 이유
		// -> POST 요청 시 인코딩 처리 필요 - 인코딩 필터 처리(web.xml 참고)
